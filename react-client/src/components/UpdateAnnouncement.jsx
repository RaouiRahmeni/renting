                ...
                <div className="announcementForm" >
                    ...
                    <div className="announcementFormGroup">
                        <div className="input-container">
                            <input value={this.props.announcement.title} type="text" placeholder="title.." id="fileInput" className="input-field" onChange={this.handleChangeTitle.bind(this)} />
                        </div>
                        <div className="input-container">
                            <textarea value={this.props.announcement.description} placeholder="description .." type="text" className="input-field" onChange={this.handleChangeDescription.bind(this)}>
                            </textarea>
                        </div>
                        <div className="input-container">
                            <input value={this.props.announcement.address} type="text" placeholder="address.." className="input-field" onChange={this.handleChangeAddress.bind(this)} />
                        </div>
                        <div className="input-container">
                        ...
                        <div className="input-container">
                            <input type="text" value={this.props.announcement.extraAccomodations} placeholder="Extra accomodations.." className="input-field" onChange={this.handleChangeExtraAccomodations.bind(this)} />
                        </div>
                        <div className="input-container">
                            <input type="date" value={this.getDate(this.props.announcement.startDate)} placeholder="Start date.." className="input-field" onChange={this.handleChangeStartDate.bind(this)} />
                        </div>
                        <div className="input-container">
                            <input type="date" value={this.getDate(this.props.announcement.endDate)} placeholder="End date.." className="input-field" onChange={this.handleChangeEndDate.bind(this)} />
                        </div>
